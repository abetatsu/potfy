...
<section class="container py-4 my-5 bg-white">
    <div class="row my-4 text-muted col-md-9 mx-auto">
      <h2 class="h5 col-12 text-center">利用規約</h2>
    </div>

    <div class="row my-4 text-muted col-md-9 mx-auto">
      <p class="line-height-2">この利用規約（以下「本利用規約」といいます）は、<a href="https://twitter.com/gaogaogate">@gaogaogate</a>（以下「当方」といいます）がこのウェブサイト上で提供するサービス（以下「本サービス」といいます）の利用条件を定めるものです。登録ユーザーの皆さま（以下「ユーザー」といいます）には、本利用規約に従って、本サービスをご利用いただきます。</p>
    </div>
    ...
    <div class="row my-4 text-muted col-md-9 mx-auto">  
      ...
      （2）本利用規約に違反したことがある者からの申請である場合<br>
      （3）成年被後見人、被保佐人または被補助人のいずれかであり、法定代理人、後見人、保佐人または補助人の同意等を得ていなかった場合<br>
      （4）反社会的勢力等（暴力団、暴力団員、右翼団体、反社会的勢力、その他これに準ずる者を意味します。）である、または資金提供その他を通じて反社会的勢力等の維持、運営もしくは経営に協力もしくは関与する等反社会的勢力との何らかの交流もしくは関与を行っていると当方が判断した場合<br>
      （5）その他、当方が利用登録を相当でないと判断した場合</p>
    </div>
    ...
    <div class="row my-4 text-muted col-md-9 mx-auto">
      ...
      （8）当方、本サービスの他の利用者または第三者の知的財産権、肖像権、プライバシー、名誉その他の権利または利益を侵害する行為<br>
      （9）過度に暴力的な表現、露骨な性的表現、人種、国籍、信条、性別、社会的身分、門地等による差別につながる表現、自殺、自傷行為、薬物乱用を誘引または助長する表現、その他反社会的な内容を含み他人に不快感を与える表現を、投稿または送信する行為<br>
      （10）営業、宣伝、広告、勧誘、その他営利を目的とする行為（当方の認めたものを除きます。）、性行為やわいせつな行為を目的とする行為、面識のない異性との出会いや交際を目的とする行為、他のお客様に対する嫌がらせや誹謗中傷を目的とする行為、その他本サービスが予定している利用目的と異なる目的で本サービスを利用する行為<br>
      （11）宗教活動または宗教団体への勧誘行為<br>
      （12）その他、当方が不適切と判断する行為</p>
    </div>
    ...
    <div class="row my-4 text-muted col-md-9 mx-auto">
      ...
      当方は、本サービスの提供の停止または中断により、ユーザーまたは第三者が被ったいかなる不利益または損害について、理由を問わず一切の責任を負わないものとします。</p>
    </div>
    ...
    <div class="row my-4 text-muted col-md-9 mx-auto">
      ...
      （3）当方からの問い合わせその他の回答を求める連絡に対して30日間以上応答がない場合<br>
      （4）第2条第2項各号に該当する場合<br>
      （5）その他、当方が本サービスの利用を適当でないと判断した場合<br>
